...
from multimodels.clusteringmultioutputmodel import ClusteringMultiOutputGPModel
...
class MMSAEA(Algorithm):
    def run(self):
        ...
        model = ClusteringMultiOutputGPModel(exact_feval=True, optimize_restarts=10, verbose=False,
